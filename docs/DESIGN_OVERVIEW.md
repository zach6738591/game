...
- Separation between simulation core and presentation layer, now including a Tkinter-based 2D GUI for map visualization.

## Milestones
1. **Prototype (Current)**: Turn-based CLI prototype plus a 2D GUI map showcasing liaison units, structured reports, and a sample mission.
