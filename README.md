...
- An advanced 2D GUI command center with posture controls, humanitarian overlays, faction dashboards, and a real-time action deck reminiscent of classic riot-management strategy games.
...
2. **Run the sample scenario** (terminal view):
   ...
   Within the GUI you can queue collaborative actions, adjust posture, pause/step through minutes, and export summaries directly from the interface.
